...
{ 
	...
	if($detection_vote == 0)
	{
		...
		if($note == 1) echo '<a href="#"><img src="./img/vote_plus_full.png" /></a>'; 
		else echo '<a href="#"><img src="./img/vote_moin_full.png" /></a>';
	}
	else
	{
		if($detection_vote == 1) echo '<a href="#"><img src="./img/vote_plus_full.png" /></a>'; 
		else echo '<a href="#"><img src="./img/vote_moin_full.png" /></a>';
	}
}
